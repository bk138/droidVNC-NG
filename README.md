...
* Due to [limitations in Android API](https://android.googlesource.com/platform/frameworks/base/+/refs/heads/android16-release/media/java/android/media/projection/MediaProjectionConfig.java#120),
