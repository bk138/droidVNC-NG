/*
 * DroidVNC-NG Concrete implementation of INetIfData, used to gather all the needed info about a network interface.
 *
...
public class NetIfData implements INetIfData {
    ...
    private NetIfData(NetworkInterface nic, Network net) {
        ...
        try {
            // Since when nic is null, most probably, it will be the "any" interface, so, consider it enabled
