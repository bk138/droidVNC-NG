/*
 * DroidVNC-NG NetIfDataDefaultNameDecorator, decorator for NetIfData that simply shows
 * the raw name of the interface (with a slight friendlier name for the "any" and "loopback" ones).
 *
