...
public class InputService extends AccessibilityService {
    ...
    private static final HotkeyBinding[] HOTKEY_BINDINGS = new HotkeyBinding[]{
    ...
    public static HotkeyBinding[] getShortcutHandlers() {
    ...
    private void longPress(int x, int y) {
        int duration = ViewConfiguration.getTapTimeout() + ViewConfiguration.getLongPressTimeout();
        dispatchGesture(createClick(x, y, duration), null, null);
    }
